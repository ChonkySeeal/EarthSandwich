...
function SearchList() {
  ...
  let { writer, pageNumber } = useParams();
  ...
  return (
    <div className="searchListContainer p-2">
      ...
      <Pagination className="justify-content-center">
        ...
        {pageNumber - 2 >= 0 ? (
          <Pagination.Item
            onClick={() => {
              navigate(`/user/${writer}/${pageNumber - 2}`);
            }}
          >
            {pageNumber - 2}
          </Pagination.Item>
        ...
        {pageNumber - 1 >= 0 ? (
          <Pagination.Item
            onClick={() => {
              navigate(`/user/${writer}/${pageNumber - 1}`);
            }}
          >
            {pageNumber - 1}
          </Pagination.Item>
        ...
        <Pagination.Last
          onClick={() => {
            navigate(`/user/${writer}/${totalPageNumber}`);
          }}
        />
      </Pagination>
    </div>
